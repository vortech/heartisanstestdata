...
//			char* rest1 = strtok(NULL,",");
//			char* rest2 = strtok(NULL,",");
//			char* rest3 = strtok(NULL,",");
...
//
//			    // 	"2016-05-20 09:48:09.01","00,63,DF,00,1F,70,00,05,FF,E3,FF,F2"
//			    // "\"2016-05-20 09:48:09.00\"\0\"00,63,DF,00,1F,70,00,05,FF,E3,FF,F2\"\n
//
//			    sscanf(rowstr, "%c %d-%d-%d%d:%d:%d.%2d %c,%c, %c,%c,%c,%c,%c,%c,%c,%c,%c,%c,%c",&bkslash,
//			    		&y, &m, &d, &h, &mi, &s, &ms, &bkslash,
